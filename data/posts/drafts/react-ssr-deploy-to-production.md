...
description: How to deploy a React SSR to Google Cloud Platform
...
1. Build the webpack bundles for client-side and server-side
2. Upload the client-side bundles to Cloud Storage
3. Upload the server-side bundles to App Engine
4. Start the SSR server

I will be building upon the project from [this article](https://www.suhanwijaya.com/posts/intro-to-react-server-side-rendering).
