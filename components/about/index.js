...
const About = (props) => {
	return (
		<section id={'about-section'} className={cn(style.about, utilStyle.homeSection)}>
			...
			<p className={cn(style.content, style.mobile)}>View my <a href='/assets/suhan_wijaya_resume.pdf' target='_black'>resume</a>.</p>
			<p className={cn(style.content, style.desktop)}>View my <a href='/assets/suhan_wijaya_resume.pdf' target='_black'>resume</a>.</p>
		</section>
	);
};
