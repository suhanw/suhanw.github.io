	...
	return (
		<section id={'toolbox-section'} className={cn(style.toolbox, utilStyle.homeSection)}>
			...
			<div className={style.icons}>
				...
				<TechIcon imageSrc={'/tech-icons/msw.svg'} imageCaption={`Mock Service Worker`} />
				<TechIcon imageSrc={'/tech-icons/react-testing-library.png'} imageCaption={`Testing Library`} />
				...
				<TechIcon imageSrc={'/tech-icons/sequelize.png'} imageCaption={`Sequelize`} />
				<TechIcon imageSrc={'/tech-icons/active-record.png'} imageCaption={`Active Record`} />
