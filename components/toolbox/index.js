...
const Toolbox = (props) => {
  return (
    <section
      id={"toolbox-section"}
      className={cn(style.toolbox, utilStyle.homeSection)}
    >
      <h2 className={style.title}>toolbox</h2>
      <div className={style.icons}>
        <TechIcon
          imageSrc={"/tech-icons/javascript.jpeg"}
          imageCaption={`JavaScript`}
        />
        <TechIcon
          imageSrc={"/tech-icons/typescript.jpeg"}
          imageCaption={`TypeScript`}
        />
        ...
        <TechIcon
          imageSrc={"/tech-icons/nodejs.png"}
          imageCaption={`Node.js`}
        />
        <TechIcon
          imageSrc={"/tech-icons/esbuild.png"}
          imageCaption={`ESBuild`}
        />
        <TechIcon
          imageSrc={"/tech-icons/webpack.png"}
          imageCaption={`webpack`}
        />
        <TechIcon imageSrc={"/tech-icons/redux.png"} imageCaption={`Redux`} />
        <TechIcon
          imageSrc={"/tech-icons/react-router.png"}
          imageCaption={`React Router`}
        />
        <TechIcon imageSrc={"/tech-icons/babel.png"} imageCaption={`Babel`} />
        <TechIcon
          imageSrc={"/tech-icons/css-modules.png"}
          imageCaption={`CSS Modules`}
        />
        <TechIcon imageSrc={"/tech-icons/less.png"} imageCaption={`Less`} />
        <TechIcon imageSrc={"/tech-icons/bem.png"} imageCaption={`BEM`} />
        <TechIcon
          imageSrc={"/tech-icons/mui.png"}
          imageCaption={`Material UI`}
        />
        <TechIcon
          imageSrc={"/tech-icons/storybook.png"}
          imageCaption={`Storybook`}
        />
        <TechIcon
          imageSrc={"/tech-icons/express.png"}
          imageCaption={`Express.js`}
        />
        <TechIcon imageSrc={"/tech-icons/hapi.png"} imageCaption={`Hapi.js`} />
        <TechIcon
          imageSrc={"/tech-icons/next-js.svg"}
          imageCaption={`Next.js`}
        />
        <TechIcon imageSrc={"/tech-icons/rails.png"} imageCaption={`Rails`} />
        <TechIcon
          imageSrc={"/tech-icons/graphql.png"}
          imageCaption={`GraphQL`}
        />
        <TechIcon imageSrc={"/tech-icons/openai.jpg"} imageCaption={`OpenAI`} />
        <TechIcon imageSrc={"/tech-icons/jest.png"} imageCaption={`Jest`} />
        <TechIcon imageSrc={"/tech-icons/mocha.png"} imageCaption={`Mocha`} />
        <TechIcon
          imageSrc={"/tech-icons/msw.svg"}
          imageCaption={`Mock Service Worker`}
        />
        <TechIcon
          imageSrc={"/tech-icons/react-testing-library.png"}
          imageCaption={`Testing Library`}
        />
        <TechIcon imageSrc={"/tech-icons/enzyme.png"} imageCaption={`Enzyme`} />
        <TechIcon
          imageSrc={"/tech-icons/thumbor.jpg"}
          imageCaption={`Thumbor`}
        />
        <TechIcon
          imageSrc={"/tech-icons/passport.png"}
          imageCaption={`Passport.js`}
        />
        <TechIcon
          imageSrc={"/tech-icons/socketio.png"}
          imageCaption={`Socket.io`}
        />
        <TechIcon imageSrc={"/tech-icons/pusher.png"} imageCaption={`Pusher`} />
        <TechIcon
          imageSrc={"/tech-icons/postgresql.png"}
          imageCaption={`PostgreSQL`}
        />
        <TechIcon
          imageSrc={"/tech-icons/sequelize.png"}
          imageCaption={`Sequelize`}
        />
        <TechIcon
          imageSrc={"/tech-icons/active-record.png"}
          imageCaption={`Active Record`}
        />
        <TechIcon
          imageSrc={"/tech-icons/mongodb.png"}
          imageCaption={`MongoDB`}
        />
        <TechIcon
          imageSrc={"/tech-icons/mongoose.jpg"}
          imageCaption={`Mongoose`}
        />
        ...
        <TechIcon
          imageSrc={"/tech-icons/browserstack.png"}
          imageCaption={`BrowserStack`}
        />
        <TechIcon
          imageSrc={"/tech-icons/responsively.png"}
          imageCaption={`Responsively`}
        />
        <TechIcon
          imageSrc={"/tech-icons/vsc.png"}
          imageCaption={`Visual Studio Code`}
        />
        <TechIcon
          imageSrc={"/tech-icons/github-copilot.webp"}
          imageCaption={`GitHub Copilot`}
        />
        <TechIcon imageSrc={"/tech-icons/figma.png"} imageCaption={`Figma`} />
        <TechIcon imageSrc={"/tech-icons/zeplin.png"} imageCaption={`Zeplin`} />
        <TechIcon
          imageSrc={"/tech-icons/postman.png"}
          imageCaption={`Postman`}
        />
        <TechIcon imageSrc={"/tech-icons/slack.jpg"} imageCaption={`Slack`} />
        <TechIcon imageSrc={"/tech-icons/jira.jpg"} imageCaption={`JIRA`} />
        <TechIcon
          imageSrc={"/tech-icons/confluence.jpg"}
          imageCaption={`Confluence`}
        />
        <TechIcon imageSrc={"/tech-icons/notion.jpg"} imageCaption={`Notion`} />
        <TechIcon
          imageSrc={"/tech-icons/google-analytics.jpg"}
          imageCaption={`Google Analytics`}
        />
        <TechIcon
          imageSrc={"/tech-icons/google-lighthouse.png"}
          imageCaption={`Google Lighthouse`}
        />
        <TechIcon
          imageSrc={"/tech-icons/google-search-console.svg"}
          imageCaption={`Google Search Console`}
        />
      </div>
    </section>
  );
